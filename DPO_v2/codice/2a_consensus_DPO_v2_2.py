...
# Categorie Gold 
categories = ["Wordplay", "Cultural Reference", "Absurdity", "Edgy Content"]
...
merged_df['Global_Borda_Rank'] = (merged_df['Wordplay_Borda_Rank_Sum'] + 
                                  merged_df['Cultural Reference_Borda_Rank_Sum'] + merged_df['Absurdity_Borda_Rank_Sum'] + 
                                  merged_df['Edgy Content_Borda_Rank_Sum']).rank(method='min')
...
output_file = "dataset_LPR_new_DPO_v2_2.csv"
